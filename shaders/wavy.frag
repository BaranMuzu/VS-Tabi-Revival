// not sure who wrote this originally, this gets passed around a lot lol
...
void main()
{
    ...
    float dx=.0003*intensity*snoise_octaves(uv*1.+iTime*vec2(.00323,.00345),5,.85,-3.,iTime*vec2(-.0323,-.345),1.203);
    float dy=.0004*intensity*snoise_octaves(uv*2.+3.+iTime*vec2(-.00323,.00345),5,.85,-3.,iTime*vec2(-.0323,-.345),1.203);
